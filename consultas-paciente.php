...
if (isset($_GET['p'])) {
    ...
    $paciente->loadById($pacienteid);
} else {
    header("Location: index.php");
}

if ($user->getTipo() == 1 && $paciente->getId() > 0) {
    $passadas = Agendamento::ListaPassadasPaciente($pacienteid, $user->getId());
} else {
    header("Location: index.php");
}
        ...
        <main>
            ...
            <div class="container-fluid px-4">
                ...
                <ol class="breadcrumb mb-4">
                    ...
                    <li class="breadcrumb-item active">Consultas Passadas de: <?php echo $paciente->getNome(); ?></li>
                </ol>
                <hr>
                <?php

                if ($passadas['num'] < 1) {
                    echo "<span class='mt-3'><b>Não há consultas passadas já finalizadas do paciente selecionado.</b></span><hr>";
                } else { ?>
                    <div class="card mb-4">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td style="text-align: center; vertical-align: middle;"><b><?php echo $paciente->getNome(); ?></b></td>
